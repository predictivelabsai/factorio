...
DEMOS = {
    "en": {
        "triage": ("We invoiced Globex Corporation for $38,000, issued today, due in 60 days. "
                   "It's on SoliqOnline and buyer-confirmed. Seller is Bright Textiles LLC."),
        "assistant": "What's my net annual return and which sector am I most exposed to?",
    },
    "ru": {
        "triage": ("Мы выставили счёт Globex Corporation на $38,000, выписан сегодня, срок 60 дней. "
                   "Счёт в SoliqOnline и подтверждён покупателем. Продавец — Bright Textiles LLC."),
