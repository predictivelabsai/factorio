...
PLANS = {
    "investor": (
        ...
        [("chat", "/app"), ("dashboard", "/app/dashboard"), ("marketplace", "/app/marketplace"),
         ("detail", None), ("auctions", "/app/marketplace/auctions"),
         ("secondary", "/app/marketplace/secondary"), ("portfolio", "/app/portfolio"),
    ...
    "admin": (
        ...
        [("chat", "/app"), ("console", "/app/admin"), ("onboarding", "/app/admin/onboarding"),
         ("processing", "/app/admin/processing"), ("risk", "/app/admin/risk"),
