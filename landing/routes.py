...
def pricing(req):
    ...
    tiers = [
        ...
        },
        {
            ...
            "features": {
                "en": ["Minimum 500,000 UZS per invoice", "Risk grades A–D", "Auto-invest available", "Secondary market (coming soon)", "Real-time portfolio tracking"],
                "uz": ["Har bir hisob-faktura uchun minimal 500,000 UZS", "A–D xavf darajalari", "Avtoinvestitsiya mavjud", "Ikkilamchi bozor (tez kunda)", "Real vaqtda portfel kuzatuvi"],
                "ru": ["Минимум 500 000 UZS за счёт", "Рейтинги риска A–D", "Автоинвестирование", "Вторичный рынок (скоро)", "Отслеживание портфеля в реальном времени"],
            }.get(lang, []),
        ...
        },
        {
            ...
            "blurb": {"en": "For businesses with 1B+ UZS monthly invoice volume. Dedicated terms, API access, and priority verification.",
                      "uz": "Oylik 1 mlrd+ UZS hisob-faktura hajmiga ega korxonalar uchun. Maxsus shartlar, API kirish va ustuvor tekshirish.",
                      "ru": "Для бизнеса с ежемесячным объёмом счетов 1 млрд+ UZS. Индивидуальные условия, доступ к API и приоритетная верификация."}.get(lang),
            "features": {
